...
var molPaintJS = (function (molpaintjs) {
  ...
  molpaintjs.Widget = function (contextId, prop, mp) {
    ...
    function actionCopy(evt) {
      ...
      document.getElementById(evt.target.id + "dummyId").value = w.write(
        ctx.getMolecule()
      );
      dummy.select();
    ...
    function actionClear(evt) {
      ...
      for (var a in molecule.getAtoms()) {
        actionList.addAction(
          molPaintJS.Action("DEL", "ATOM", null, molecule.getAtom(a))
        );
      }
      for (var b in molecule.getBonds()) {
        actionList.addAction(
          molPaintJS.Action("DEL", "BOND", null, molecule.getBond(b))
        );
      }
    ...
    function actionInfo(evt) {
      ...
      var content = decodeURI(molPaintJS.Resources["help.html"]).replace(
        "data:text/html;charset=UTF-8,",
        ""
      );
      e.innerHTML = content
        .replaceAll("data:text/html;charset=UTF-8,", "")
    ...
    function actionPasteButton(evt) {
      try {
        ...
        alert(
          "In Chrome, please install the 'AllowClipboard' extension.\n" +
    ...
    function renderBondMenu() {
      return (
        ...
        "onclick=\"window.molPaintJS.setCurrentBond('" +
        widgetId +
        "');\" >" +
        item("currentBond", "single_bond", "", "molPaintJS-inactiveTool") +
        "</a><div id='" +
        widgetId +
        "_bondMenu' class='molPaintJS-leftDropdown-content'>" +
        "<table><tr>" +
    ...
    function renderCanvas() {
      return (
        ...
        "' height='" +
        height +
        "' class='molPaintJS-canvas' contenteditable='true' >" +
    ...
    function renderIsotopeMenu() {
      return (
        ...
        item(
          ...
          "isotope_up",
          "Isotope menu",
          "molPaintJS-inactiveTool"
        ) +
        "</a><div id='" +
        widgetId +
        "_isotopeMenu' class='molPaintJS-rightDropdown-content'>" +
        "<table>" +
    ...
    function renderLeftMenu() {
      return (
        itemV("pointer", "Select, Translate, Rotate", "molPaintJS-activeTool") +
    ...
    function renderPeriodicTable() {
      var header =
        ...
        widgetId +
        "_pse' src='" +
        molPaintJS.Resources["pse.png"] +
        "' title='Periodic table' " +
        "width='" +
        iconSize +
        "' class='molPaintJS-inactiveTool' /></a>" +
        "  <div  id='" +
        widgetId +
        "_pseMenu' class='molPaintJS-rightDropdown-content'>" +
        "  <table class='molPaintJS-elementTable'>";

      var footer = "</table>" + "</div>" + "</div>" + "</td></tr>";
      ...
      for (var isotopes of molPaintJS.Elements.getAllElements()) {
        ...
        tbl +=
          ...
          "onclick=\"window.molPaintJS.setElement('" +
          widgetId +
          "','" +
          el.getSymbol() +
          "');\"><span style='color: " +
    ...
    function renderRadicalMenu() {
      return (
        ...
        "</a><div id='" +
        widgetId +
        "_radicalMenu' class='molPaintJS-rightDropdown-content'>" +
        "<table><tr>" +
    ...
    function renderTemplateMenu() {
      ...
      var header =
        ...
        "</a><div id='" +
        widgetId +
        "_templateMenu' class='molPaintJS-leftDropdown-content'>" +
        "<table>";
    ...
    function renderTopMenu() {
      return (
        itemH("clear", "Clear", "molPaintJS-defaultTool") +
    ...
    return {
      ...
      renderWidget: function () {
        if (!viewer) {
          widgetObject.innerHTML =
            "<div style='position: relative;'>" +
            "<div id='" +
            widgetId +
            "_modalDlg' class='molPaintJS-modalDlg'></div>" +
            "<table><tr><td colspan=3><table>" +
            "<tr>" +
            renderTopMenu() +
            "</tr></table></td></tr>" +
            "<tr>" +
            "<td class='molPaintJS-leftMenubar'><table>" +
            renderLeftMenu() +
            "</table></td>" +
            "<td>" +
            renderCanvas() +
            "</td>" +
            "<td class='molPaintJS-rightMenubar'><table>" +
            renderRightMenu() +
            "</table></td>" +
            "</tr>" +
